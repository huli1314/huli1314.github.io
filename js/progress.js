...
const clues = [
    ...
    { id: 16, name: "物业公告栏", path: "property/notice/index.html", found: false },
    { id: 17, name: "电梯维修记录", path: "property/elevator/index.html", found: false },
    { id: 18, name: "601水电记录", path: "property/water/index.html", found: false },
    { id: 19, name: "601住户登记", path: "archive/resident/601.html", found: false },
    { id: 20, name: "2018巡逻日志", path: "archive/patrol/log/2018.html", found: false },
    { id: 21, name: "方敏的小红书", path: "xiaohongshu/post2.html", found: false }
];

const TOTAL_CLUES = 21;
...
function recordClue(clueId) {
    ...
    if (!foundIds.includes(clueId)) {
        ...
        console.log(`%c[线索] 已收集：${clues[clueId - 1].name} (${foundIds.length}/${TOTAL_CLUES})`, "color: #8b6b4d");
    }
}
    ...
    if (collected === TOTAL_CLUES) {
        ...
        progressDiv.innerHTML = `
            <div style="background:#2a1a1a; padding:15px; margin-top:20px; text-align:center; border:1px solid #c44;">
                ...
                <p style="color:#888; font-size:12px;">已收集 ${collected}/${TOTAL_CLUES} 条线索，还差 ${remaining} 条</p>
